...
import com.songdo.aws_study.domain.user.Role;
...
public class OAuthAttributes {
    ...
    /*
    of()
    OAuth2User에서 반환하는 사용자 정보는 Map()이기 때문에 값 하나하나를 변환해야함
     */
    ...
    OAuthAttributes 클래스 생성이 끝났으면 같은 퍀키지에 SessionUser 클래스를 생성
     */
